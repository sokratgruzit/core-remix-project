...
export function getStringCompletionItems(
  range: IRange,
  monaco
...
export function getBytesCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
...
export function getBlockCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
    ...
    {
      detail:
        "(bytes32): DEPRICATED In 0.4.22 use blockhash(uint) instead. Hash of the given block - only works for 256 most recent blocks excluding current",
...
export function getCompletionSnippets(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
...
export function getTxCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
...
export function getMsgCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
    ...
    {
      detail:
        "(bytes4): first four bytes of the calldata (i.e. export function identifier)",
      kind: monaco.languages.CompletionItemKind.Property,
      insertText: "sig",
      label: "sig",
      range,
...
export function getAbiCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
    ...
    {
      detail:
        "encodePacked(..) returns (bytes): Performes packed encoding of the given arguments",
...
export function GetCompletionTypes(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
...
export function GeCompletionUnits(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  const completionItems = [];
  ...
  return [
    ...
    },
    {
      detail:
        ...
        "compute the CORE-SHA-3 (Keccak-256) hash of the (tightly packed) arguments",
...
export function getArrayCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
...
export function getAddressCompletionItems(
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
  return [
    ...
    {
      detail:
        "(uint256 amount): send given amount of Wei to Address, throws on failure",
      kind: monaco.languages.CompletionItemKind.Method,
...
export function getContextualAutoCompleteBTypeName(
  word: string,
  range: IRange,
  monaco
): monaco.languages.CompletionItem[] {
