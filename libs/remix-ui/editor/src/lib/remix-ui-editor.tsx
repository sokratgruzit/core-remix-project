...
export const EditorUI = (props: EditorUIProps) => {
  ...
  const [editorModelsState, dispatch] = useReducer(
    reducerActions,
    initialState
  );
  ...
  const defineAndSetTheme = (monaco) => {
    ...
    monaco.editor.defineTheme(themeName, {
      ...
      rules: [
        ...
        { token: "comment.js", foreground: "#198437" },
        { token: "comment.css", foreground: "#198437" },
        // global variables
      ...
      colors: {
        ...
        "editor.background": "#00050f",
        // "editorSuggestWidget.background": lightColor,
        "editorSuggestWidget.background": "#00050f",
        "editorSuggestWidget.selectedBackground": "#0F1218",
        "editorSuggestWidget.selectedForeground": "#FFF",
        "editorSuggestWidget.highlightForeground": primaryColor,
        "editorSuggestWidget.focusHighlightBackground": "#ff0000",
        "editor.lineHighlightBorder": secondaryColor,
        "editor.lineHighlightBackground":
          textbackground === darkColor ? "#0F1218" : "#0F1218",
        "editorGutter.background": "#00050f",
        //'editor.selectionHighlightBackground': secondaryColor,
        "minimap.background": "#00050f",
  ...
  return (
    <div className="w-100 h-100 d-flex flex-column-reverse">
      <Editor
        ...
        options={{
          glyphMargin: true,
          readOnly: !editorRef.current || !props.currentFile,
        }}
