...
function RightSlider({
  ...
  return (
    <>
      <div
        className="openRightSlider border"
        style={{ display: rightSliderOpen ? "none" : "flex" }}
        onClick={() => setRightSliderOpen((prevState) => !prevState)}
      >
        <svg
          width="8"
          height="12"
      ...
      >
        ...
        <div className="files">
          <div className="files-wrap">
            <div className="icon-hover" onClick={() => connectToLocalhost()}>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <div className="files-wrap">
            <div className="icon-hover-orange" onClick={() => createNewFile()}>
              <span
                className="d-flex"
