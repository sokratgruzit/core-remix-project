  ...
  return (
    ...
    >
      <div className="d-flex justify-content-between">
        <label
          className="py-2 align-self-center m-0"
          style={{ fontSize: "1.2rem" }}
        >
          Learn
        </label>
        <button onClick={() => openLink()} className="h-100 px-2 pt-0 btn">
          <img
      ...
      <div className="d-flex flex-column">
        ...
        >
          <label className="m-0 float-left" style={{ fontSize: "1rem" }}>
            Remix Basics
          </label>
        ...
        <button
          ...
          onClick={() =>
            setState((prevState) => {
              return {
                ...prevState,
                visibleTutorial: VisibleTutorial.Advanced,
              };
            })
          }
        >
