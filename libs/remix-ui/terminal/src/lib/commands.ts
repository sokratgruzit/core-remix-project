export const allPrograms = [
  {
    ethers:
      "The ethers.js library is a compact and complete JavaScript library for CORE.",
  },
  { remix: "Apeirogon IDE and tools for the web." },
  {
    web3: "The web3.js library is a collection of modules which contain specific functionality for the CORE ecosystem.",
  },
...
export const allCommands = [
  ...
  {
    "ethers.providers":
      "A Provider abstracts a connection to the CORE blockchain, for issuing queries and sending state changing transactions.",
  },
  ...
  // { 'ethers.utils.RLP': 'This encoding method is used internally for several aspects of CORE, such as encoding transactions and determining contract addresses.' },
  {
    "ethers.Wallet":
      "A wallet manages a private/public key pair which is used to cryptographically sign transactions and prove ownership on the CORE network.",
  },
  { "ethers.version": "Contains the version of the ethers container object." },

  { "web3.eth": "Eth module for interacting with the CORE network." },
  {
    "web3.eth.accounts":
      "The web3.eth.accounts contains functions to generate CORE accounts and sign transactions and data.",
  },
  // TODO: need to break down the object return from abi response
  // { 'web3.eth.abi': 'The web3.eth.abi functions let you de- and encode parameters to ABI (Application Binary Interface) for function calls to the EVM (CORE Virtual Machine).' },
  {
    "web3.eth.ens": "The web3.eth.ens functions let you interacting with ENS.",
  },
  {
    "web3.eth.Iban":
      "The web3.eth.Iban function lets convert CORE addresses from and to IBAN and BBAN.",
  },
  { "web3.eth.net": "Net module for interacting with network properties." },
  {
    "web3.eth.personal":
      "Personal module for interacting with the CORE accounts.",
  },
  {
    "web3.eth.subscribe":
  ...
  {
    "web3.givenProvider":
      "When using web3.js in an CORE compatible browser, it will set with the current native provider by that browser. Will return the given provider by the (browser) environment, otherwise null.",
  },
  ...
  {
    "web3.utils":
      "This package provides utility functions for CORE dapps and other web3.js packages.",
  },
  { "web3.version": "Contains the version of the web3 container object." },

  { "web3.eth.clearSubscriptions();": "Resets subscriptions." },
  //   { 'web3.eth.Contract(jsonInterface[, address][, options])': 'The web3.eth.Contract object makes it easy to interact with smart contracts on the CORE blockchain.' },
  //   { 'web3.eth.accounts.create([entropy]);': 'The web3.eth.accounts contains functions to generate CORE accounts and sign transactions and data.' },
