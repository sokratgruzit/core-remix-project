 ...
 *
 * @param {String} path - relative path (Unix style which is the one used by Apeirogon IDE)
 ...
 * @param {String} sharedFolder - absolute shared path. platform dependent representation
 * @return {String} relative path (Unix style which is the one used by Apeirogon IDE)
 */
