...
export class ExternalHttpProvider extends AbstractProvider {
  ...
  body (): JSX.Element {
    ...
    return (
      <>
        <div className="">
            Note: To use Geth & http://core-ide.shopgeorgia.ge, configure it to allow requests from Remix:(see <a href="https://geth.ethereum.org/docs/rpc/server" target="_blank" rel="noreferrer">Geth Docs on rpc server</a>)
          <div className="border p-1">geth --http --http.corsdomain http://core-ide.shopgeorgia.ge</div>
          <br />
