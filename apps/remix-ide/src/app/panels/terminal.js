...
class Terminal extends Plugin {
  constructor(opts, api) {
    ...
    this._deps = {
      ...
      offsetToLineColumnConverter: this.globalRegistry.get(
    ...
    this.event.register("debuggingRequested", async (hash) => {
      ...
      if (!(await this._opts.appManager.isActive("debugger")))
        await this._opts.appManager.activatePlugin("debugger");
