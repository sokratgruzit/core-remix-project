    ...
    if (!localStorage.getItem("hadTour_initial")) {
      introJs()
        .setOptions({
          steps: [
            {
              title: "Welcome to Apeirogon IDE",
              intro:
            ...
            },
            {
              ...
              intro:
                "Having selected a .sol file in the File Explorer (the icon above), compile it with the Solidity Compiler.",
              tooltipClass: "bg-light text-dark",
              position: "right",
            },
            {
        ...
        .onafterchange((targetElement) => {
          ...
          const skipbutton =
            document.getElementsByClassName("introjs-skipbutton")[0];
          if (skipbutton) {
