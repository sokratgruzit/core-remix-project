...
const testData = {
  pluginName: "remixIde",
  pluginDisplayName: "Apeirogon IDE",
...
module.exports = {
  ...
  "Should activate plugins": function (browser: NightwatchBrowser) {
    browser
      ...
      .waitForElementVisible(
        '*[data-id="pluginManagerComponentDeactivateButtonvyper"]',
        70000
      )
      .scrollAndClick(
        '*[data-id="pluginManagerComponentActivateButtonZoKrates"]'
  ...
  "Should connect a local plugin": function (browser: NightwatchBrowser) {
    browser
      ...
      .clearValue('*[data-id="localPluginName"]')
      .setValue('*[data-id="localPluginName"]', testData.pluginName)
      .clearValue('*[data-id="localPluginDisplayName"]')
      .setValue(
        '*[data-id="localPluginDisplayName"]',
        testData.pluginDisplayName
      )
      .clearValue('*[data-id="localPluginUrl"]')
  ...
  "Should load back installed plugins after reload": function (
