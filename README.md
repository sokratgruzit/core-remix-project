<p align="center">
  <img src="./apps/remix-ide/src/assets/img/icon.png" alt="Apeirogon Logo" width="200"/>
</p>
<h3 align="center">Apeirogon Project</h3>
...
**Remix Project** is a rich toolset including Apeirogon IDE, a comprehensive smart contract development tool. The Remix Project also includes Remix Plugin Engine and Remix Libraries which are low-level tools for wider use.

## Apeirogon IDE

**Apeirogon IDE** is used for the entire journey of contract development by users of any knowledge level. It fosters a fast development cycle and has a rich set of plugins with intuitive GUIs. The IDE comes in 2 flavors and a VSCode extension:
...
Remix libraries are essential for Apeirogon IDE's native plugins. Read more about libraries [here](libs/README.md)
...
Open `http://127.0.0.1:8080` in your browser to load Apeirogon IDE locally.
